...
describe('Value class', () => {
    ...
    // describe('Value constructor', () => {
    //     it('should initialize value property as an empty object when no assets are provided', () => {
    //         const assets: Asset[] = [];
    //         const valueInstance = new Value(assets);
    //         expect(valueInstance.value).toEqual({});
    //     });

    //     it('should initialize value property with a single asset', () => {
    //         const assets: Asset[] = [
    //             { unit: 'BTC', quantity: BigInt(1000) }
    //         ];
    //         const valueInstance = new Value(assets);
    //         expect(valueInstance.value).toEqual({
    //             'BTC': BigInt(1000)
    ...
    //     it('should initialize value property with multiple assets', () => {
    //         const assets: Asset[] = [
    //             { unit: 'BTC', quantity: BigInt(1000) },
    //             { unit: 'ETH', quantity: BigInt(500) }
    //         ];
    //         const valueInstance = new Value(assets);
    //         expect(valueInstance.value).toEqual({
    //             'BTC': BigInt(1000),
    ...
    //     it('should initialize value property with assets having zero quantity', () => {
    //         const assets: Asset[] = [
    //             { unit: 'BTC', quantity: BigInt(0) },
    //             { unit: 'ETH', quantity: BigInt(0) }
    //         ];
    //         const valueInstance = new Value(assets);
    //         expect(valueInstance.value).toEqual({
    //             'BTC': BigInt(0),
    ...
    //     it('should initialize value property with assets having negative quantity', () => {
    //         const assets: Asset[] = [
    //             { unit: 'BTC', quantity: BigInt(-1000) },
    //             { unit: 'ETH', quantity: BigInt(-500) }
    //         ];
